"""
Django settings for lucky_silence_dev_63350 project.
...
ROOT_URLCONF = 'lucky_silence_dev_63350.urls'
...
WSGI_APPLICATION = 'lucky_silence_dev_63350.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_silence_dev_63350 API",
    "DESCRIPTION": "API documentation for lucky_silence_dev_63350 App",
    "VERSION": "v1",
}
